  ...
  return (
    <div className="pt-5">
      <div className="flex flex-wrap ">
        <div
          className="w-full flex items-center justify-center md:flex-row md:justify-center md:items-center md:gap-8 mt-20 pb-12 md:pb-16"
          data-aos="fade-up"
        >
          ...
          <div className="flex items-center gap-1.5 md:gap-6">
            ...
            >
              <IoMail className="text-2xl md:text-4xl text-yellow-50 hover:text-yellow-200" />
            </a>
            <a
            ...
            >
              <FaGithubSquare className="text-2xl md:text-4xl text-yellow-50 hover:text-yellow-200" />
            </a>
            <a
            ...
            >
              <FaLinkedin className="text-2xl md:text-4xl text-yellow-50 hover:text-yellow-200" />
            </a>
            <a
            ...
            >
              <FaInstagramSquare className="text-2xl md:text-4xl text-yellow-50 hover:text-yellow-200" />
            </a>
          </div>
        </div>
